      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center mb-14 md:mb-20">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-7xl font-bold mb-8">The Guardian</h1>
          ...
          <div className="mb-20 md:mb-32">
            <div className="text-center mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold">Core Features</h2>
            </div>
          ...
          <div className="mb-20 md:mb-32 max-w-5xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-8">Technology Roadmap</h2>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold">Technical Specifications (Guardian V2)</h2>
            </div>
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100">
              ...
              <table className="w-full min-w-[560px]">
                <thead className="bg-gradient-to-r from-primary/10 to-primary/5">
                  <tr>
                    <th className="text-left py-4 md:py-5 px-4 md:px-8 font-bold text-gray-900 uppercase tracking-wider text-xs md:text-sm">Feature</th>
                    <th className="text-left py-4 md:py-5 px-4 md:px-8 font-bold text-gray-900 uppercase tracking-wider text-xs md:text-sm">Specification</th>
                  </tr>
                </thead>
                <tbody>
                  {specifications.map((spec, index) => (
                    <tr key={index} className={`border-b border-gray-100 hover:bg-gray-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}`}>
                      <td className="py-4 md:py-5 px-4 md:px-8 font-semibold text-gray-900 text-sm md:text-base">{spec.feature}</td>
                      <td className="py-4 md:py-5 px-4 md:px-8 text-gray-600 text-sm md:text-lg">{spec.specification}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
